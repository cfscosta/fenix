	...
	<logic:notEmpty name="individualCandidaciesHashCodesNotBounded">
		...
		<logic:iterate id="hash" name="individualCandidaciesHashCodesNotBounded">
			...
			<tr>
				...
				<td>
					<%= pt.ist.fenixWebFramework.servlets.filters.contentRewrite.GenericChecksumRewriter.NO_CHECKSUM_PREFIX %><a href="http://fenix.ist.utl.pt/candidaturas/lic/vinte_tres_anos/submissao?hash=<%= code %>">Candidaturas 1� Ciclo</a>
				</td>
				<td>
